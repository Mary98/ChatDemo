...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.mary.chatdemo.fastjson.IMClientManager.getInstance(this).initMobileIMSDK();
    ...
    private void doLoginImpl() {
        ...
        com.mary.chatdemo.fastjson.IMClientManager.getInstance(this).getBaseEventListener()
